         ...
         <div class="menu-container">
            <div class="menu">
                    <div class="topimg">
                            ...
                            <!-- Redirect link -->
                            <div class="button"><a href="MesArticles.php" class="btn1">Retour en arriére</a></div>
                    </div>
               ...
               <?php  
                ...
                ?>
                  ...
                  <!-- Performs the actions written in the a on the database based on the article id -->
                    <div class="button"><a href="ModifArticle.php?id=<?= $article_id; ?>" class="btn1">Modifier l'article</a></div>
                
                    <div class="button"><a href="../actions/articles/deleteArticle.php?id=<?= $article_id; ?>" class="btn2">Supprimer l'article</a></div>
                <?php
        }
          ?>
            </div>
